...
<br><br><br>
			<div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
				<table id="farms_banks_details" class="table-responsive table-bordered" width='100%'>
						<tr>
						...
						<tr id='farms_banks_list_<?php echo $farms_banks_detail['id'];?>'>
							...
							<td>
								<select name='id_country[<?php echo $values['id']?>]' id='id_country_<?php echo $farms_banks_detail['id']?>' onchange="updateFarmsBanksDetail(<?php echo $farms_banks_detail['id'];?>,'id_country_<?php echo $farms_banks_detail['id'];?>','id_country')">
									<option value=''>...</option>
