							...
							<div class="col-sm-12  col-md-12">
								<label for="">Observación <small class="text-danger">(*)</small></label>
                                                                <textarea class="form-control input-sm datetimepicker1 activarse" id="" placeholder="" name="observacion_seguimiento"><?php if(isset($values['observacion_seguimiento'])) echo $values['observacion_seguimiento'];?></textarea>
							...
							<div class="col-sm-12  col-md-12">
								...
								<select name="follow_status" class="form-control input-sm activarse">
							...
							<div class="col-sm-6  col-md-6">
								...
								<input id = "follow_amount" type="text" min="0"  step="0.01" autocomplete="off" class="form-control input-sm activarse" id="" placeholder="" name="follow_amount" value="<?php if(isset($values['follow_amount'])) echo $values['follow_amount']?>">
