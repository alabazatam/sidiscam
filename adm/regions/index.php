		...
		if(count($regions_list_json)>0)
		{
			foreach ($regions_list_json as $regions) 
			{
				...
				if($status == 0)
				{
                                        ...
                                        if($_SESSION['rol'] == "ADM")
                                        {
                                            $onclick = "onclick = ".'"'."status_changer('regions','id_region', '$id_region','1')".'"'."";
				...
				if($status == 1)
				{
                                        ...
                                        if($_SESSION['rol'] == "ADM")
                                        {
                                            $onclick = "onclick = ".'"'."status_changer('regions','id_region', '$id_region','0')".'"'."";
			...
			$array_json['data'][0] = array("id_region"=>null,"name"=>"","abr"=>"","status"=>"","date_created"=>"","date_updated"=>"","actions"=>"");
		}
