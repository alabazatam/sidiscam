	...
	?>
		...
		<tr id='banks_list_<?php echo $values['id'];?>'>
			...
			<td>
				<input type='text'  name='rif[<?php echo $values['id']?>]' id='rif_<?php echo $values['id']?>' size="20" autocomplete="off" onchange="updateClientsBanksDetail(<?php echo $values['id'];?>,'rif_<?php echo $values['id'];?>','rif')">			
			</td>
			<td>
