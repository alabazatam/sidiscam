<tr id='products_list_<?php echo $values['id'];?>'>
	...
	<td><input type='number' min="0" value="0" name='rate[<?php echo $values['id']?>]' id='rate_<?php echo $values['id']?>' size="6" autocomplete="off" onchange="updateSalesProductsDetail(<?php echo $values['id'];?>,'rate_<?php echo $values['id'];?>','rate')"></td>
	<td><input type='text' min="0" value="0" readonly="readonly" name='amount[<?php echo $values['id']?>]' id='amount_<?php echo $values['id']?>' size="6" autocomplete="off" onchange="updateSalesProductsDetail(<?php echo $values['id'];?>,'amount_<?php echo $values['id'];?>','amount')"></td>
