...
<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xs-offset-2 col-sm-offset-2 col-md-offset-2 col-lg-offset-2">
	<h1 class="text-center">Tipos de venta</h1>	<form class="form-horizontal" action="index.php" method="POST">
	  ...
	  <div class="form-group">
		<div class="col-sm-3">
		<label for="">Id</label>
		<input autocomplete="off" readonly="readonly" type="text" class="form-control input-sm" id="" placeholder="" name="id_type_destiny" value="<?php if(isset($values['id_type_destiny'])) echo $values['id_type_destiny']?>">
		</div>
	  </div>
	  <div class="form-group">
		<div class="col-sm-6">
      ...
      <div class="form-group">
		...
		<a class="btn btn-default"  href="<?php echo full_url."/adm/type_destiny/index.php"?>"><i class="fa fa-arrow-left  fa-pull-left fa-border"></i> Regresar</a>
