<?php
    ...
    class InvoicesPDF 
    {
		...
		$html = '<table border="0" width="100%">'
			...
			. '<td width="30%">&nbsp;</td>'
			. '<td width="10%">&nbsp;</td>'
			. '<td width="30%" style="text-align: right;"><strong>Make All Checks payable to:</strong></td>'
			. '</tr>'
			. '<tr>'
			. '<td>&nbsp;</td>'
			. '<td>&nbsp;</td>'
			. '<td style="text-align: left;"><strong>Beneficiary:</strong></td>'
			...
			. '<td style="text-align: left;"><strong>ABA#: </strong></td>'
