...
CREATE TABLE IF NOT EXISTS `banks_tables_id` (
...
(1, 'BROKER1', 'br1', 1, 'direccion de prueba', '4268141850', '', 'deandrademarcos@gmail.com', '', '2016-04-30 12:56:04', '2016-06-12 00:25:52'),
...
(5, 'jesus', NULL, 1, 'callr 2', '00584145771816', '', 'jesus@broker.com', '', '2016-06-28 08:27:20', '2016-06-28 08:27:20'),
(6, 'SN TRADING S.A.R.L. ', NULL, 1, '2 Anclen Chemin de Muret 32 600 L''ISLE JOURDAIN FRANCE', '33610611540', '', 'SNTRADING@GMAIL.COM', '', '2016-07-07 11:05:32', '2016-07-07 11:05:32');
...
CREATE TABLE IF NOT EXISTS `brokers_banks_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `brokers_banks_detail`
--
...
(5, 5, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2016-06-28 08:27:27', '2016-06-28 08:27:27');
...
(1, 'cliente1', 'V-18020594-9', 1, 1, 'DIRECCION DE PRUEBA', '02128601223', '04268141850', 'DEANDRADEMARCOS@GMAIL.COM', '', 'NOMBRE', '04268141850', 'DEANDRADEMARCOS@GMAIL.COM', '', '', '', '2016-04-28 20:45:40', '2016-08-16 20:48:39'),
...
(5, 'Twin Tails Seafood Corporation', '', 1, 65, '8325 NW 30th Terrace, Miami, FL 33122 ', '3054778266', '', 'mrivero@twintailsseafood.com', '', 'M Rivero', '3054778266', 'mrivero@twintailsseafood.com', '', '', '', '2016-06-23 13:37:26', '2016-06-23 13:37:26'),
(6, 'carlos', '1555426644', 1, 1, 'Calle 21', '04265164747', '', '', '', 'carlos', '0426544516', 'carlos@camaron.com', '', '', '', '2016-06-28 08:23:33', '2016-06-28 08:23:33'),
(7, 'MAISON MER ', '', 1, 71, 'RUE SAMUEL CHAMPLAIN', '33253784793', '', 'maisonmer@hotmail.com', '', 'MAISON  MER ', '33253784793', 'maisonmer@hotmail.com', '', '', '', '2016-07-08 12:48:49', '2016-07-08 12:48:49'),
(8, 'MAISON MER ', '', 1, 71, 'RUE SAMUEL CHAMPLAIN', '33253784793', '', 'maisonmer@hotmail.com', '', 'MAISON  MER ', '33253784793', 'maisonmer@hotmail.com', '', '', '', '2016-07-08 12:53:41', '2016-07-08 12:53:41');
...
CREATE TABLE IF NOT EXISTS `clients_address_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_client` int(11) NOT NULL,
  `id_country` int(11) DEFAULT NULL,
  `address` text,
...
--
-- Dumping data for table `clients_address_detail`
--
...
(11, 6, 1, NULL, 1, '2016-06-28 08:23:42', '2016-06-28 08:23:42');
...
CREATE TABLE IF NOT EXISTS `clients_banks_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_client` int(11) NOT NULL,
  `bank_name` varchar(50) DEFAULT NULL,
  `number` varchar(50) DEFAULT NULL,
...
--
-- Dumping data for table `clients_banks_detail`
--
...
(42, 6, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2016-06-28 08:26:17', '2016-06-28 08:26:17');
...
(1, 'V-20303709-7', 'COSEINCA1', 'MARCOS DE ANDRADE', 'V-18020594', 1, 'aaaaaaaaaaaaaaaaa', '04268141850', '04261234567', 'deandrademarcos@gmail.com', 'deandrademarcos@gmail.com', 'MARCOS', '04141234567', 'marcos@g.com', 'ARLINDO', '04261412374', 'arlindo@gmail.com', 1, '2016-04-02 21:28:41', '2016-06-18 17:33:55'),
...
(5, '15426641255', 'tucamaron punto com', 'Yhon', '154555145', 1, 'calle valboa', '04165764546', '', '', '', 'luz mery', '0426454544', 'luz@tucamron.com', '', '', '', 1, '2016-06-28 08:32:40', '2016-06-28 08:32:40');
...
CREATE TABLE IF NOT EXISTS `company_banks_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_company` int(11) NOT NULL,
  `bank_name` varchar(50) DEFAULT NULL,
  `number` varchar(50) DEFAULT NULL,
...
--
-- Dumping data for table `company_banks_detail`
--
...
(12, 1, 'banco', '0101010101010101', 1, '5454545', 'ABA', 'SWIT', 'IBAN', 1, '2016-06-11 13:55:46', '2016-06-11 13:55:46'),
(14, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2016-06-20 12:24:08', '2016-06-20 12:24:08'),
(15, 5, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2016-06-28 08:32:48', '2016-06-28 08:32:48');
...
--
-- Dumping data for table `connections_history`
--

INSERT INTO `connections_history` (`id_connection`, `id_user`, `login`, `ip`, `date_created`) VALUES
(7, 7, 'admin', '190.203.107.47', '2016-06-25 12:43:01'),
(8, 7, 'admin', '130.1.23.59', '2016-06-28 08:09:18'),
(9, 7, 'admin', '190.38.231.69', '2016-06-28 19:20:05'),
(10, 7, 'admin', '190.153.40.243', '2016-06-30 16:36:26'),
(11, 7, 'admin', '201.242.94.210', '2016-07-02 11:08:49'),
(12, 7, 'admin', '190.74.228.38', '2016-07-05 15:12:50'),
(13, 7, 'admin', '181.208.224.171', '2016-07-06 15:00:43'),
(14, 7, 'admin', '181.208.224.171', '2016-07-06 15:01:12'),
(15, 7, 'admin', '181.208.224.171', '2016-07-07 10:04:25'),
(16, 7, 'admin', '181.208.224.171', '2016-07-08 10:21:32'),
(17, 7, 'admin', '181.208.224.171', '2016-07-11 12:09:26'),
(18, 7, 'admin', '181.208.224.171', '2016-07-11 12:10:24'),
(19, 7, 'admin', '181.208.224.171', '2016-07-11 12:54:51'),
(20, 7, 'admin', '181.208.224.171', '2016-07-14 15:19:20'),
(21, 7, 'admin', '201.208.244.206', '2016-07-16 07:10:43'),
(22, 7, 'admin', '190.38.231.69', '2016-07-18 21:52:46'),
(23, 7, 'admin', '190.38.231.69', '2016-07-19 21:11:13'),
(24, 7, 'admin', '186.185.44.121', '2016-07-19 21:13:10'),
(25, 7, 'admin', '181.208.224.171', '2016-07-26 14:18:34'),
(26, 7, 'admin', '190.204.142.2', '2016-08-13 10:36:18'),
(27, 7, 'admin', '190.204.142.2', '2016-08-13 14:39:15'),
(28, 7, 'admin', '190.204.142.2', '2016-08-13 14:40:32'),
(29, 7, 'admin', '186.93.39.109', '2016-08-13 17:34:55'),
(30, 7, 'admin', '186.93.39.109', '2016-08-13 17:36:05'),
(31, 7, 'admin', '186.93.39.109', '2016-08-13 21:23:23'),
(32, 7, 'admin', '186.93.39.109', '2016-08-14 17:16:34'),
(33, 7, 'admin', '186.93.39.109', '2016-08-14 17:20:15'),
(34, 7, 'admin', '186.93.39.109', '2016-08-14 18:24:29'),
(35, 7, 'admin', '190.38.231.69', '2016-08-15 20:00:53'),
(36, 7, 'admin', '190.38.231.69', '2016-08-15 21:15:19'),
(37, 7, 'admin', '186.93.39.109', '2016-08-16 20:42:32'),
(38, 7, 'admin', '201.209.155.4', '2016-08-18 22:25:19'),
(39, 7, 'admin', '201.209.155.4', '2016-08-18 22:25:46'),
(40, 7, 'admin', '201.209.155.4', '2016-08-18 23:21:13'),
(41, 7, 'admin', '201.209.155.4', '2016-08-19 20:10:07'),
(42, 7, 'admin', '190.205.180.83', '2016-08-20 19:12:08'),
(43, 7, 'admin', '201.210.156.15', '2016-08-22 20:42:24'),
(44, 7, 'admin', '190.38.231.69', '2016-08-22 20:46:26'),
(45, 7, 'admin', '201.209.137.133', '2016-08-24 21:30:31'),
(46, 7, 'admin', '201.209.137.133', '2016-08-24 21:31:05'),
(47, 7, 'admin', '201.209.137.133', '2016-08-24 21:48:15'),
(48, 7, 'admin', '201.209.137.133', '2016-08-24 21:53:01'),
(49, 7, 'admin', '201.209.137.133', '2016-08-24 21:56:35'),
(50, 7, 'admin', '201.209.137.133', '2016-08-24 22:02:50'),
(51, 7, 'admin', '201.209.137.133', '2016-08-24 22:07:06'),
(52, 7, 'admin', '181.208.224.171', '2016-08-25 11:42:25'),
(53, 7, 'admin', '200.1.12.1', '2016-08-29 07:53:04'),
(54, 7, 'admin', '200.1.12.1', '2016-08-29 07:58:37'),
(55, 7, 'admin', '200.1.12.203', '2016-08-29 10:31:35'),
(56, 7, 'admin', '200.1.12.203', '2016-08-29 10:35:42'),
(57, 7, 'admin', '200.1.12.203', '2016-08-29 10:37:03'),
(58, 7, 'admin', '200.1.12.203', '2016-08-29 10:43:20'),
(59, 7, 'admin', '200.1.12.203', '2016-08-29 11:04:23'),
(60, 7, 'admin', '200.1.12.203', '2016-08-29 11:46:33'),
(61, 7, 'admin', '186.185.34.11', '2016-08-29 12:28:55'),
(62, 7, 'admin', '200.1.12.203', '2016-08-30 11:06:33'),
(63, 7, 'admin', '200.1.12.203', '2016-08-30 14:30:49'),
(64, 7, 'admin', '200.1.12.203', '2016-08-31 11:11:41'),
(65, 7, 'admin', '200.1.12.203', '2016-08-31 15:08:20'),
(66, 7, 'admin', '200.1.12.203', '2016-08-31 15:09:13'),
(67, 7, 'admin', '200.1.12.203', '2016-08-31 15:10:29'),
(68, 7, 'admin', '200.1.12.203', '2016-08-31 15:11:18'),
(69, 7, 'admin', '200.1.12.203', '2016-08-31 15:50:45'),
(70, 7, 'admin', '200.1.12.203', '2016-08-31 16:19:03'),
(71, 7, 'admin', '190.38.231.69', '2016-08-31 21:22:16'),
(72, 7, 'admin', '190.38.231.69', '2016-09-01 19:58:36'),
(73, 7, 'admin', '200.1.12.203', '2016-09-02 10:44:46'),
(74, 7, 'admin', '201.208.233.173', '2016-09-02 22:56:14');
...
(1, 'GRANJA1', 1, 1, 'G00', 0, 'Dirección', '02121234567', '02121234567', 'email1@h.com', '', 'contact1', '02121234567', 'daaaa@h.com', 'email1@h.com', '02121234567', '', 1, '2016-04-15 10:20:20', '2016-06-12 00:28:08'),
(2, 'GRANJA2', 1, 1, 'GR2', 0, 'Hello how are youy', '1234567890', '', '', '', 'nombre1', '0426814150', 'deandrademarcos@gmail.com', '', '', '', 1, '2016-04-15 15:22:59', '2016-06-25 12:03:38'),
...
(4, 'Cria tu pez', 1, 23, NULL, NULL, 'calle playa grande', '02125554165', '', '', '', 'Esteban de Jesus', '02126635477', 'ej@criatupez.com', '', '', '', 1, '2016-06-28 08:40:53', '2016-06-28 08:40:53');
...
CREATE TABLE IF NOT EXISTS `farms_banks_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `farms_banks_detail`
--
...
(1, 'Cost and FReight', 'CFR', 'Costo y Flete. El vendedor se hace cargo de todos los costos y el transporte principal, hasta que la mercancía llegue al puerto de destino. El riesgo se transfiere al comprador en el momento que la mercancía se encuentra cargada en el buque, en el país de origen', 1, '2016-04-30 12:39:20', '2016-06-30 16:53:03'),
(2, 'Cost Insurance and Freight', 'CIF', 'Costo Seguro y Flete. El vendedor se hace cargo de todos los costos, incluidos el transporte principal y el seguro, hasta que la mercancía llegue al puerto de destino. Aunque el seguro lo ha contratado el vendedor, el beneficiario del seguro es el comprador', 1, '2016-04-30 12:39:20', '2016-06-30 16:53:09'),
(3, 'Carriage and Insurance Paid to', 'CIP', 'Porte y Seguro Pagado Hasta. El vendedor se hace cargo de todos los costos hasta que la mercancía llegue al punto convenido en el país de destino. El riesgo se transfiere al comprador en el momento de la entrega de la mercancía al transportista dentro del país de origen', 0, '2016-04-30 12:39:20', '2016-06-28 08:41:54'),
(4, 'Carriage Paid To', 'CPT', 'Porte Pagado Hasta. El vendedor asume todos los costos, incluido el transporte principal, hasta que la mercancía llegue al punto convenido en el país de destino. Sin embargo, el riesgo se transfiere al comprador en el momento de la entrega de la mercancía al transportista dentro del país de origen', 0, '2016-04-30 12:39:20', '2016-06-28 08:41:51'),
(5, 'Delivered At Place', 'DAP', 'Entregado en un lugar. El vendedor asume todos los costos pero no de los costos asociados a la importación, hasta que la mercancía se ponga a disposición del comprador en un vehículo listo para ser descargado. También asume los riesgos hasta ese momento', 0, '2016-04-30 12:39:20', '2016-06-28 08:41:47'),
(6, 'Delivered At Terminal', 'DAT', 'Entregado en terminal. El vendedor asume todos los costos, incluido: transporte principal y el seguro (que no es obligatorio), hasta que se descarga en el terminal convenido. También asume los riesgos hasta ese momento', 0, '2016-04-30 12:39:20', '2016-06-28 08:41:43'),
(7, 'Delivered Duty Paid', 'DDP', 'Entregado con derechos pagados. El vendedor paga todos los gastos hasta dejar la mercancía en el punto convenido en el país de destino. El comprador no realiza ningún tipo de trámite. Los gastos de aduana de importación son asumidos por el vendedor', 0, '2016-04-30 12:39:20', '2016-06-28 08:41:36'),
(8, 'EX Works', 'EXW', 'Puesto en Planta. El vendedor pone la mercancía a disposición del comprador en sus instalaciones o fábrica. Todos los gastos a partir de ese momento son por cuenta del comprador', 1, '2016-04-30 12:39:20', '2016-06-30 16:53:13'),
(9, 'Free Alongside Ship', 'FAS', '"Libre a un Costado del Buque. El vendedor entrega la mercancía en el muelle pactado del puerto de carga convenido; esto es, al lado del barco. El vendedor es responsable de la gestión y costo de la aduana de exportación "', 0, '2016-04-30 12:39:20', '2016-06-28 08:41:29'),
(10, 'Free CArrier', 'FCA', 'Libre transportista. El vendedor se compromete a entregar la mercancía en un punto acordado dentro del país de origen, se hace cargo de los costos hasta que la mercancía está situada en ese punto convenido', 0, '2016-04-30 12:39:20', '2016-06-28 08:41:24'),
...
(25, 20, 'Estadisticas de Comercializacion', '/adm/graficas/index.php', '', 1, 1, '2016-06-11 12:36:46', '2016-06-11 12:36:48'),
(26, 20, 'Estadisticas de Produccion Y Logistica', '/adm/graficas/index2.php', '', 1, 1, '2016-06-11 12:36:46', '2016-06-11 12:36:48'),
(27, 20, 'Reporte 1', '/adm/reporte1/index.php', '', 1, 1, '2016-06-11 12:36:46', '2016-06-11 12:36:48');
...
(1, 'planta 1', 'V-18020594-9', 1, 1, 'DIRECCION DE PRUEBA', '02128601223', '04268141850', 'DEANDRADEMARCOS@GMAIL.COM', '', 'Nombre', '04268141850', 'deandrademarcos@gmail.com', '', '', '', '2016-04-28 20:45:40', '2016-06-25 12:05:30'),
(2, 'PLANTA 2', 'V-12341563-9', 1, 1, 'DIRECCION DE PRUEBA', '02128601223', '', '', '', '', '', '', '', '', '', '2016-04-28 21:47:46', '2016-04-28 21:47:46'),
(3, 'Procesadora Antartica, C.A. ', 'J-295660510', 1, 1, 'AV. N°5 San Francisco Sector El Bajo Maracaibo Edo. Zulia', '042617613520', '', 'merbis.amaya@antartica.com.ve', '', 'Merbis Amaya', '02617613520', 'merbis.amaya@antartica.com.ve', '', '', '', '2016-06-23 15:03:00', '2016-06-25 12:22:02'),
(4, 'empaque camaron', 'j-574557456', 1, 1, 'edo vargas', '0212365744', '', '', '', 'garcia', '02126320817', 'empaque@ec.com', '', '', '', '2016-06-28 08:45:59', '2016-06-28 08:45:59');
...
CREATE TABLE IF NOT EXISTS `plants_banks_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `plants_banks_detail`
--
...
(13, 4, 'mercantil', '222445245215', 1, 'j6525524563', NULL, NULL, NULL, 1, '2016-06-28 08:46:05', '2016-06-28 08:46:05'),
(14, 4, 'Banesco', '244545435435', 1, 'j55142366566', NULL, NULL, NULL, 1, '2016-06-28 08:46:34', '2016-06-28 08:46:34');
...
(3, 'LANGOSTINO', 'LANGOSTINO', 1, '2016-06-28 08:47:27', '2016-06-28 08:47:27');
...
(17, 3, 'ENTERO', 'PESCA', NULL, 1, '2016-06-28 08:49:19', '2016-06-28 08:49:19');
...
(9, 2, 1, 4, 5, 12, '2016-06-30', 1, 6, 236, 248, '2016-07-04', '2016-07-29', NULL, NULL, NULL, 9, 'Contado', NULL, NULL, 11, '', 1, '2016-06-30 16:39:15', '2016-06-30 16:45:44'),
(10, 2, 2, 5, 1, 14, '2016-06-28', 1, 6, 65, 417, '2016-07-07', '2016-07-22', NULL, NULL, NULL, 0, 'CONTADO', NULL, NULL, 2, '', 1, '2016-06-30 16:55:32', '2016-06-30 16:59:46'),
(11, 2, 1, 1, 3, 12, '2016-06-23', 1, 6, 65, 417, '2016-07-01', '2016-08-09', NULL, NULL, NULL, 1, 'CONTADO', NULL, NULL, 1, '', 1, '2016-06-30 17:02:24', '2016-06-30 17:08:16'),
(12, 2, 1, 4, NULL, 12, '2016-06-30', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Contado', NULL, NULL, 2, '', 1, '2016-07-11 14:35:08', '2016-07-11 14:35:08'),
(13, 2, 1, 4, NULL, 12, '2015-12-24', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '40 000 usd anticipated against proforma\r\nSold 10 days before arrival to destination port', NULL, NULL, 1, '', 1, '2016-07-18 21:54:35', '2016-07-18 21:54:35'),
(14, 2, 1, 2, NULL, 12, '2016-08-14', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'prueba para graficos', NULL, NULL, 1, 'prueba', 1, '2016-08-14 17:34:27', '2016-08-14 17:34:27'),
(15, 2, 1, 2, NULL, 12, '2016-08-18', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'efectivo', NULL, NULL, 1, 'felix t', 1, '2016-08-18 22:29:51', '2016-08-18 22:29:51'),
(16, 2, 5, 5, NULL, 15, '2016-08-20', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'cvfb', NULL, NULL, 1, 'fv', 1, '2016-08-20 19:12:55', '2016-08-20 19:12:55');
...
CREATE TABLE IF NOT EXISTS `sales_containers_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `sales_containers_detail`
--
...
CREATE TABLE IF NOT EXISTS `sales_farms_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_sale` int(11) NOT NULL,
  `id_farm` int(11) NOT NULL,
  `date_created` datetime NOT NULL,
...
--
-- Dumping data for table `sales_farms_detail`
--
...
CREATE TABLE IF NOT EXISTS `sales_plants_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_sale` int(11) NOT NULL,
  `id_plant` int(11) NOT NULL,
  `date_created` datetime NOT NULL,
...
--
-- Dumping data for table `sales_plants_detail`
--
...
CREATE TABLE IF NOT EXISTS `sales_products_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_sale` int(11) NOT NULL,
  `id_product` int(11) NOT NULL,
...
--
-- Dumping data for table `sales_products_detail`
--

INSERT INTO `sales_products_detail` (`id`, `id_sale`, `id_product`, `id_product_type`, `cases`, `packing`, `quantity`, `rate`, `amount`, `note`, `id_plant`, `id_farm`, `id_broker`, `precinto`, `number`, `comision`, `date_created`, `date_updated`, `status`) VALUES
...
(11, 1, 1, 7, 1, 8, 2, '0.02', '0.04', NULL, 1, 1, 4, 'precinto1', '555', '201110.10', '2016-06-24 14:49:18', '2016-06-24 14:49:18', 1),
...
(15, 9, 3, 17, 60, 200, 21600, '3.05', '65880.00', NULL, 3, 1, 1, '5', '123456789101112', '0.00', '2016-06-30 16:41:33', '2016-06-30 16:41:33', 1),
(16, 10, 1, 1, 100, 50, 9000, '4.30', '38700.00', NULL, 3, 3, 2, '0.5', 'lkm6754389', '0.00', '2016-06-30 16:55:56', '2016-06-30 16:55:56', 1),
(17, 11, 2, 12, 150, 80, 21600, '2.80', '60480.00', 'MNA', 2, 3, 2, '0.5', '101010101987', '0.00', '2016-06-30 17:02:44', '2016-06-30 17:02:44', 1),
(18, 3, 2, 12, 2, 3, 16, '4.25', '68.85', NULL, 3, 1, 5, '1233455667', '5FRRT6YHGR', '2.00', '2016-07-05 15:22:39', '2016-07-05 15:22:39', 1),
(19, 3, 1, 1, 3, 7, 50, '3.80', '191.52', NULL, 2, 3, 1, 'yuuyuuu778888', 'gy666t5678hh', '2.00', '2016-07-05 15:23:40', '2016-07-05 15:23:40', 1),
(20, 3, 3, 17, 4, 2, 14, '2.08', '29.95', NULL, 3, 4, NULL, NULL, NULL, NULL, '2016-07-05 15:24:44', '2016-07-05 15:24:44', 1),
(21, 12, 2, 13, 29, 10, 522, '6.70', '0.00', NULL, 1, 1, 6, '369258147', '123456789', '0.50', '2016-07-11 14:35:18', '2016-07-11 14:35:18', 1),
(22, 13, 1, 1, 2, 10, 36, '7.50', '270.00', NULL, 1, 1, 1, '0001', '01', '10.00', '2016-07-18 21:54:51', '2016-07-18 21:54:51', 1),
(23, 1, 2, 15, 1, 1, 2, '0.01', '0.02', NULL, 1, 2, 1, '34', '23', NULL, '2016-08-14 17:24:59', '2016-08-14 17:24:59', 1),
(24, 14, 3, 17, 0, 1, 2, '1.00', '1.78', NULL, 1, 1, 1, '32', '233', '34.00', '2016-08-14 17:35:00', '2016-08-14 17:35:00', 1),
(26, 15, 3, 17, 1, 1, 2, '0.02', '0.04', NULL, 3, 1, 4, 'rgrg', '5rf', '0.00', '2016-08-18 22:34:22', '2016-08-18 22:34:22', 1),
(28, 16, 1, 1, 1, 1, 4, '0.01', '0.04', NULL, 1, 1, 1, 'hy', 'hy', '9.00', '2016-08-20 19:13:04', '2016-08-20 19:13:04', 1),
(29, 8, 1, 4, NULL, NULL, 0, NULL, '0.00', NULL, NULL, NULL, 5, NULL, NULL, NULL, '2016-09-02 23:14:12', '2016-09-02 23:14:12', 1);
...
(1, 'LINEA NAVIERA1', 1, '2016-04-05 20:56:01', '2016-06-25 12:06:26', 'l', 'dirección', '1234567890', '', '', '', 'hola', '04268141850', 'deandrademarcos@gmail.com', 'contact2', '1234567890', 'deandrademarcos@gmail.com'),
(2, 'LINEA NAVIERA 2', 1, '2016-04-05 20:56:19', '2016-06-25 12:06:33', 'l2', 'direccion', '02128601223', '', '', '', 'aaaa', '04268141850', 'dddd@h.com', '', '', ''),
(3, 'LINEA NAVIERA 3', 1, '2016-04-15 16:39:38', '2016-06-25 12:06:34', 'aaa', 'aaaaaaaaaaaa', '1234567890', '', '', '', 'sssss', '04268141850', 'dddd@h.com', '', '', ''),
...
(5, 'Merk', 1, '2016-06-28 08:43:14', '2016-06-28 08:43:14', NULL, 'Av intercumunal', '04154453454', '', '', '', 'luis', '04265167171', 'luis@merk.com', '', '', '');
...
CREATE TABLE IF NOT EXISTS `type_destiny` (
...
--
-- Dumping data for table `type_destiny`
--
...
(1, 'mdeandrade', '18bfddf1020067bbd33fad652bc8f1a59b2427ff8c7ebfd62bbfef6c2dddff49', 1, '2016-04-02 20:55:08', '2016-06-18 13:42:51', '', NULL),
...
--
ALTER TABLE `bank`
  ADD CONSTRAINT `bank_country` FOREIGN KEY (`id_country`) REFERENCES `country` (`id_country`),
  ADD CONSTRAINT `bank_ibfk_1` FOREIGN KEY (`id_table`) REFERENCES `tables` (`id_table`);

--
-- Constraints for table `banks_tables_id`
--
ALTER TABLE `banks_tables_id`
  ADD CONSTRAINT `banks_tables_id_ibfk_1` FOREIGN KEY (`id_bank`) REFERENCES `bank` (`id_bank`),
  ADD CONSTRAINT `banks_tables_id_ibfk_2` FOREIGN KEY (`id_table`) REFERENCES `tables` (`id_table`);

--
-- Constraints for table `country`
--
ALTER TABLE `country`
  ADD CONSTRAINT `country_region` FOREIGN KEY (`id_region`) REFERENCES `regions` (`id_region`);

--
-- Constraints for table `ports`
--
ALTER TABLE `ports`
  ADD CONSTRAINT `port_country` FOREIGN KEY (`id_country`) REFERENCES `country` (`id_country`);

--
-- Constraints for table `sales`
--
ALTER TABLE `sales`
  ADD CONSTRAINT `sales_ibfk_1` FOREIGN KEY (`id_shipping_lines`) REFERENCES `shipping_lines` (`id_shipping_lines`);
